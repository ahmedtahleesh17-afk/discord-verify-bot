...
'📨 تم إرسال كود التفعيل إلى الإيميل الجامعي الخاص بك.\n\n' +
'📩 الرجاء الدخول إلى بريدك عبر Microsoft Outlook وتسجيل الدخول بحسابك الجامعي.\n\n' +
'🔐 ستجد رسالة تحتوي على كود التفعيل في صندوق الوارد.\n' +
'📂 في حال لم تجدها، يرجى التوجه إلى قسم "البريد الإلكتروني غير الهام" (Junk) وستجد كود التفعيل هناك.'
);
